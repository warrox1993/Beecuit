      ...
      <Container>
        ...
        <div className="border-warm-brown/10 flex flex-col gap-4 border-t py-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="text-warm-brown/60 flex gap-4">
            <a href="#" aria-label="Instagram" className="hover:text-honey-dark"><Share2 className="h-4 w-4" /></a>
            <a href="#" aria-label="Facebook" className="hover:text-honey-dark"><Globe className="h-4 w-4" /></a>
          </div>
        </div>
      </Container>
    </footer>
